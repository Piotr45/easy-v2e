    ...
    def __init__(
       ...
       :param label_signal_noise: set True to label noise events as 'special'
        ...
        if output_width == 346 and output_height == 260:
            ...
            self.polShiftBits = (
                11
            )  # see https://gitlab.com/inivation/inivation-docs/-/blob/master/Software%20user%20guides/AEDAT_file_formats.md
            self.sizex = output_width
            self.sizey = output_height
            self.flipy = (
                True
            )  # v2e uses computer vision matrix printing convention of UL pixel being 0,0, but jAER uses original graphics and graphing convention that 0,0 is LL
            self.flipx = (
                True
            )  # not 100% sure why this is needed. Observed for tennis example
            ...
            self.polShiftBits = (
                11
            )  # see https://gitlab.com/inivation/inivation-docs/-/blob/master/Software%20user%20guides/AEDAT_file_formats.md#dvs-or-aps
            self.sizex = output_width
            self.sizey = output_height
            self.flipy = (
                True
            ...
            self.polShiftBits = (
                0
            )  # see jAER DVS640 class https://github.com/SensorsINI/jaer/blob/master/src/ch/unizh/ini/jaer/chip/retina/DVS640.java
            self.sizex = output_width
            self.sizey = output_height
            self.flipy = (
                True
